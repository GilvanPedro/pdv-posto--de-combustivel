...
✅ **Verificar:** Acesse http://localhost:8082/swagger-ui.html
...
**Solução:** Certifique-se de que o back-end está rodando em http://localhost:8082

Teste no navegador:
```
http://localhost:8082/api/v1/pessoas
```
