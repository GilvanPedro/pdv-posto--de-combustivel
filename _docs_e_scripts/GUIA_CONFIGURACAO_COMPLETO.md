...
6. ✅ Backend funcionando em: http://localhost:8082
7. ✅ Swagger disponível em: http://localhost:8082/swagger-ui.html
...
- [ ] Swagger acessível em http://localhost:8082/swagger-ui.html
